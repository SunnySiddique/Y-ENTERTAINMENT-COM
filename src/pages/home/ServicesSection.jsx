            ...
            >
              <div className="mb-4 relative overflow-hidden">
                <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center group-hover:bg-blue-200 transition-colors duration-300">
                  <service.icon className="w-8 h-8 text-blue-600 group-hover:scale-110 transition-transform duration-300" />
                </div>
              ...
              <a
                href="#"
                className="text-blue-600 hover:underline group-hover:font-semibold transition-all duration-300 flex items-center"
              >
                Learn More
